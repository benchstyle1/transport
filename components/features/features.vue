<template>
  <div class="features" styleName="features">
    <div class="feature">
      <div class="picture" :class="{ bckgBlack: getTheme }">
        <svg
          :class="{ fillLtGray: getTheme }"
          width="30"
          height="24"
          viewBox="0 0 30 24"
          fill="none"
      ...
      <div class="feature-info">
        <h6 :class="{ cWhite: getTheme }">A challenge for a true champion</h6>
        <p :class="{ cLtGray: getTheme }">
    ...
    <div class="feature">
      ...
      <div class="feature-info">
        <h6 :class="{ cWhite: getTheme }">Pilot's sweaty hands</h6>
        <p :class="{ cLtGray: getTheme }">
          Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet
          sint. Velit officia consequat duis enim velit mollit.
        </p>
...
import styles from "../features/features.css";
